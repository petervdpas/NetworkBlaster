...
public sealed record RequestOptions
{
    ...
    /// <summary>Override <see cref="NetworkBlasterOptions.DefaultRetryCount"/> for this call. <c>0</c> disables retry.</summary>
    public int? RetryCount { get; init; }

    /// <summary>Override <see cref="NetworkBlasterOptions.DefaultRetryBaseDelay"/> for this call.</summary>
